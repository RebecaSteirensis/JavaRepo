 ...
 * Clase Empleado - Trabajo Practico 5
 */
...
public class Empleado extends Persona
{
     ...
     * @param p_anio
     */
    public Empleado(int p_dni, long p_cuil, String p_apellido, String p_nombre, double p_importe, int p_anio)
    {
    ...
    */
    ...
    private void setAnioIngreso(int p_anio){
        Calendar anioDeIngreso = new GregorianCalendar(p_anio, 1, 1);
